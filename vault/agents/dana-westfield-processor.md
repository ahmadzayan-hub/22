...
# MISSION
Reconciliation Processor for the finances crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "finances Reconciliation Processor" (k=8) · read: /crews/finances/*, /notes/standups/*
- write: /crews/finances/notes/<date>-dana-westfield-processor.md

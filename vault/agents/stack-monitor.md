...
# MISSION
Local Stack Health for the tech crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "tech Local Stack Health" (k=8) · read: /crews/tech/*, /notes/standups/*
- write: /crews/tech/notes/<date>-stack-monitor.md

...
# MISSION
Hook & Script Suggester for the marketing crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "marketing Hook & Script Suggester" (k=8) · read: /crews/marketing/*, /notes/standups/*
- write: /crews/marketing/notes/<date>-native-suggest.md

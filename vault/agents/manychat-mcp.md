...
# MISSION
DM Funnel Automator for the marketing crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "marketing DM Funnel Automator" (k=8) · read: /crews/marketing/*, /notes/standups/*
- write: /crews/marketing/notes/<date>-manychat-mcp.md

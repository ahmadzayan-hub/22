...
# MISSION
Launchpad Offer Runner for the sales crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "sales Launchpad Offer Runner" (k=8) · read: /crews/sales/*, /notes/standups/*
- write: /crews/sales/notes/<date>-fanbasis-launchpad.md

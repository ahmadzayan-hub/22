...
# MISSION
Stripe/PayPal/Square Matcher for the finances crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "finances Stripe/PayPal/Square Matcher" (k=8) · read: /crews/finances/*, /notes/standups/*
- write: /crews/finances/notes/<date>-payments-processor.md

...
# MISSION
Daily Posts Runner for the marketing crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "marketing Daily Posts Runner" (k=8) · read: /crews/marketing/*, /notes/standups/*
- write: /crews/marketing/notes/<date>-hiperfield-social.md

...
# MISSION
Cross-platform Publisher for the marketing crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "marketing Cross-platform Publisher" (k=8) · read: /crews/marketing/*, /notes/standups/*
- write: /crews/marketing/notes/<date>-cernio-social.md

...
# MISSION
Slack Digest for the communications crew. Keep its source-of-truth tools and the OS database in agreement.
...
# MEMORY
- top-k query: "communications Slack Digest" (k=8) · read: /crews/communications/*, /notes/standups/*
- write: /crews/communications/notes/<date>-slack-worker.md
